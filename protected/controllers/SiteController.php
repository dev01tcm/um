...
class SiteController extends Controller
{
	...
	//loadapprover
	public function actionLoadapprover(){
		$this->renderPartial('approver/index');
	}

	//loadowner
	public function actionLoadowner(){
		$this->renderPartial('owner/index');
	}
	...
	//CallUserDepartment
    public function CallUserDepartment($de_id){

    	$qusg2 = new CDbCriteria( array(
	        'condition' => "dp_id = :dp_id ",         
	        'params'    => array(':dp_id' => $de_id)  
	    ));
