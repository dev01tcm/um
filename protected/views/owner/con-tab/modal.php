...
if(isset($_POST['ide'])){
	...
	$CallApp = OwnerController::CallConByID($_POST['ide']);
	$hdid = $CallApp['ct_id'];
...
<div class="modal-body font-03">
	<div class="example-wrap">
		...
		<div class="form-group">
			...
			<select class="example-title form-control form-control-lg font-03" id="ct_type" style="line-height:2rem;padding: .429rem 1rem;">
...
<script type="text/javascript">
 $(document).ready(function() {
	$('.btn-submit').click(function(){
		...
		$.ajax({
			type: "POST",
			url:"<?php echo Yii::app()->createAbsoluteUrl("owner/savedatacon"); ?>",
			data: {
