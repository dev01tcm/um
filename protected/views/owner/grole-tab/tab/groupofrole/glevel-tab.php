				...
				<thead style="background-color:#AED6F1;">
					<tr>
						...
						<!--th class="example-title" id="ca" style="width:70px;">เปิด/ปิด <?php
							$chkmas0 = MasGroleModLev::check_stat_all($id);
							...
							<label class="switch">
								<input type="checkbox" id="change_grole" <?php echo $ch; ?> onclick="changeall()">
...
<script type="text/javascript">
	...
	function savedata() {
		...
		function(){
			...
			/*console.log(grm_id);  console.log(rol_array);  console.log(status_array);*/
			//------------------------------------------------------------------------------------------------
