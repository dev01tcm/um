...
if(isset($_POST['ide'])){
	...
	$CallApp = OwnerController::CallGRoleByID($_POST['ide']);
	$hdid = $CallApp['ra_id'];
...
<div class="modal-body font-03">
	<div class="example-wrap">
		...
		<div class="form-group">
			<p class="example-title font-03 font-w"> ชื่อ Role</p>
			<input class="form-control form-control-lg font-03 modname" id="rolename" type="text" value="<?php echo $ra_name; ?>" placeholder="ชื่อ Role">
		</div>
		<div class="form-group">
...
<script type="text/javascript">
 $(document).ready(function() {
	$('.btn-submit').click(function(){
		...
		$.ajax({
			type: "POST",
			url:"<?php echo Yii::app()->createAbsoluteUrl("owner/savedatagrole"); ?>",
			data: {
