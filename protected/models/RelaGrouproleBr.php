...
/**
 * This is the model class for table "rela_grouprole_br".
 *
 * The followings are the available columns in table 'rela_grouprole_br':
 * @property integer $gb_id
 * @property string $id_grouprole
 * @property string $id_position
 * @property string $gb_status
 * @property string $createby
 * @property string $createdate
 * @property string $updateby
 * @property string $updatedate
 */
class RelaGrouproleBr extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_grouprole, id_position, gb_status', 'length', 'max'=>10),
			...
			array('gb_id, id_grouprole, id_position, gb_status, createby, createdate, updateby, updatedate', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RelaGrouproleBr the static model class
	 */
