 ...
 */
class DbDpis extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return DbDpis the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('PER_ID, SSOFIRSTNAME, SSOSURNAME, SSOPERSONEMPDATE, TITLE, INITIALS, EMPLOYEETYPE, GIVENNAME, SN, WORKINGDEPTDESCRIPTION, SSOPERSONCLASS, SSOPERSONPOSITION, PN_NAME, SSOPERSONCITIZENID, ACCOUNTACTIVE, SSOPERSONBIRTHDATE, PICPATH, PIC_UPDATE, PER_GENDER, createby, createdate, updateby, updatedate', 'safe', 'on'=>'search'),
		);
	}
