...
/**
 * This is the model class for table "rela_grouprole_po".
 *
 * The followings are the available columns in table 'rela_grouprole_po':
 * @property integer $gp_id
 * @property string $id_grouprole
 * @property string $id_position
 * @property string $gp_status
 * @property string $createby
 * @property string $createdate
 * @property string $updateby
 * @property string $updatedate
 */
class RelaGrouprolePo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_grouprole, id_position, gp_status', 'length', 'max'=>10),
			...
			array('gp_id, id_grouprole, id_position, gp_status, createby, createdate, updateby, updatedate', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('gp_status',$this->gp_status,true);
	 ...
	 * @return RelaGrouprolePo the static model class
	 */
